...
if ($hassiteconfig) { // speedup for non-admins, add all caps used on this page
    ...
    $temp->add(new admin_setting_configtext('csvdateformat', get_string('csvdateformat', 'totara_core'), get_string('csvdateformatconfig', 'totara_core'), get_string('csvdateformatdefault', 'totara_core')));
