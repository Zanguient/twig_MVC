...
$ADMIN->add('server', new admin_externalpage('registrationindex', get_string('registration','admin'),
        "$CFG->wwwroot/$CFG->admin/registration/index.php", 'moodle/site:config'));
